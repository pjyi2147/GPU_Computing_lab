...
int main() {
  ...
  create_dataset(0, 16, 16, 1);
  create_dataset(1, 64, 64, 1);
  create_dataset(2, 64, 128, 1);
  create_dataset(3, 112, 48, 1);
  create_dataset(4, 168, 168, 1);
  create_dataset(5, 512, 510, 1);
  create_dataset(6, 1024, 1024, 1);
  create_dataset(7, 1024, 2048, 1);
  create_dataset(8, 4096, 8000, 1);
  return 0;
}
