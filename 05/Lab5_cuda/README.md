...
# Lab assignment 5 - CUDA Histogram
...
The following will compile the template file that you will modify to implement histogram in CUDA, and the data generator that will generate input files. 
